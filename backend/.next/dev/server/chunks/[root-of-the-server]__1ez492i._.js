...
"[project]/app/api/escalations/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$escalationSweep$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/escalationSweep.js [app-route] (ecmascript)");
...
async function GET(request) {
    try {
        ...
        if (status && [
            "Open",
            "Cleared"
        ].includes(status)) filter.status = status;
        const escalations = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Escalation$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find(filter).sort({
            triggeredAt: -1
        });
...
async function POST() {
    try {
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$escalationSweep$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["runEscalationSweep"])();
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            data: result
        }, {
...
"[project]/lib/escalationEngine.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/escalationSweep.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Escalation$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/models/Escalation.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$escalationEngine$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/escalationEngine.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$notifyFamily$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/notifyFamily.js [app-route] (ecmascript)");
...
async function runEscalationSweep() {
    ...
    // ---------------------------------------------------------------------
    const elders = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Elder$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({
        status: "Assigned"
    });
    ...
    const checkers = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Checker$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({
        _id: {
            $in: checkerIds
        }
    }).select("name");
    ...
    const recentVisits = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Visit$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({
        visitDate: {
            $gte: twoDaysAgo
        }
    }).sort({
    ...
    const now = new Date();
    const findings = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$escalationEngine$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["computeEscalations"])(elders, visitsByElderId, openElderIds, now, platformConfig);
    ...
    const created = await Promise.all(findings.map(async (f)=>{
        ...
        const escalation = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Escalation$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create({
            elderId: f.elderId,
        ...
        if (elder && platformConfig.notificationRules?.escalationNotificationsEnabled !== false) {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$notifyFamily$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["notifyFamily"])(elder, escalation);
        }
        return escalation;
    }));
    return {
...
"[project]/lib/notifyFamily.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Notification$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/models/Notification.js [app-route] (ecmascript)");
...
async function notifyFamily(elder, escalation) {
    ...
    const emailResults = await Promise.all(recipients.map((to)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mailer$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendEmail"])({
            to,
            subject,
            body
        })));
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Notification$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create({
...
"[project]/models/Notification.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1ez492i._.js.map