...
async function GET(request) {
    try {
        ...
        const notifications = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Notification$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({
            familyMemberId
        }).sort({
            createdAt: -1
        }).limit(50);
        const unreadCount = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Notification$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].countDocuments({
            familyMemberId,
            read: false
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
async function PATCH(request) {
    try {
        ...
        if (!familyMemberId || !markAllRead) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "familyMemberId and markAllRead are required"
            }, {
                status: 400
            });
        }
        await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Notification$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].updateMany({
            familyMemberId,
            read: false
        }, {
            read: true
...
//# sourceMappingURL=%5Broot-of-the-server%5D__12rsecn._.js.map