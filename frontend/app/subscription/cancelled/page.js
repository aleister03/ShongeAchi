  ...
  return (
    <main className="min-h-screen flex items-center justify-center" style={{ background: "#FBF3D9" }}>
      <div className="bg-white rounded-2xl shadow-sm p-10 max-w-md w-full text-center">
        ...
        <h1 className="text-xl font-bold text-gray-700 mb-2">Checkout cancelled</h1>
        <p className="text-sm text-gray-500 mb-6">No payment was made. You can restart checkout any time.</p>
        <Link
          href="/dashboard"
