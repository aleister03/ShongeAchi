  ...
  return (
    <main className="min-h-screen">
      ...
      <section className="relative w-full h-screen">
        <Image src="/hero-bg.jpg" alt="Elderly woman" fill className="object-cover" priority />
        ...
        <div className="absolute inset-0 flex flex-col justify-center px-16 md:px-24 max-w-2xl">
          ...
          <Link href="#how-it-works" className="self-start px-8 py-3 rounded-full border border-white/70 text-white text-sm font-medium hover:bg-white/20 transition">
            See How it Works?
          </Link>
        </div>
      </section>
